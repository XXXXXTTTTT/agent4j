...
import { confirmMcp, confirmSkill, listMcpCatalog, listMcpInstallations, listSkillInstallations, prepareMcpMaterial, previewMcp, previewSkill, searchSkills, startMcpInstallation, stopMcpInstallation, uninstallMcpInstallation, uninstallSkillInstallation, type GitHubSkillRepository, type McpCatalog, type McpInstallation, type McpPreview, type SkillInstallation, type SkillPreview, type InstallationScope } from '../api/capabilityApi'
